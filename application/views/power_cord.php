...
<head>
  ...
  <link rel="canonical" href="<?php echo base_url(); ?>power-cord-series" />

  <meta name="title" content="<?php echo $nama_halaman; ?> - <?php echo $company_profile->data->nama; ?>">
  <meta name="description" content="Produk Power Cord <?php echo $company_profile->data->nama; ?>">
  ...
  <meta name="url" content="<?php echo base_url(); ?>power-cord-series">
  <meta name="identifier-URL" content="<?php echo base_url(); ?>power-cord-series">

  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="<?php echo base_url(); ?>power-cord-series">
  ...
  <meta property="twitter:url" content="<?php echo base_url(); ?>power-cord-series">
...
<body>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $.getJSON("<?php echo base_url(); ?>api/power_cord_series_list", function(data) {
        var items = [];
