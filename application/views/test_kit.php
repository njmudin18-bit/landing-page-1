...
<html class="no-js" lang="en">
  <head>
    ...
    <link rel="canonical" href="<?php echo base_url(); ?>test-kit" />
    ...
    <meta name="url" content="<?php echo base_url(); ?>test-kit">
    <meta name="identifier-URL" content="<?php echo base_url(); ?>test-kit">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo base_url(); ?>test-kit">
    ...
    <meta property="twitter:url" content="<?php echo base_url(); ?>test-kit">
  ...
  <body>
    ...
    <main>
      ...
      <div class="contact-section recent-area test-kit section-paddingt">
        <div class="container">

          <div class="row">
            <div class="col-lg-12">
              <div class="section-tittle text-center">
                <h2>Alat Pengujian</h2>
              </div>
            </div>
          </div>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $.getJSON("<?php echo base_url(); ?>api/test_kit_list", function(data) {
          var items = [];
          
          $.each(data.data, function(key, val) {
            items.push( '<div class="col-xl-3 col-lg-3 col-md-6 mb-30" title="' + val.nama + '">' +
                          '<div class="single-recent-cap mb-30">' +
                            '<div class="recent-img">' +
                              '<img src="<?php echo API_URL; ?>upload/fasilitas_images/'+ val.image +'" alt="<?php echo $company_profile->data->nama; ?>">' +
                            '</div>' +
                            '<div class="recent-cap">' +
                              //'<span>'+  val.nama +'</span>' +
                                '<h4 class="text-center">' +
                                  '<a href="#" target="_blank">' + val.nama +
                                  '</a>' +
                                '</h4>' +
                              //'<p>' + val.nama + '</p>' +
                            '</div>' +
